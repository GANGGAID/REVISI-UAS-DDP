...
int main()
{
    ...
    cout << "9. persegi panjang 3d (balok)"<<endl;
    cout << "10. persegi 3d (kubus)"<<endl;
    ...
    switch (i){
        ...
        break;
        case 9:
        cout << "persegi panjang 3d (balok)"<<endl;
        int pp,pl,pt,pb;
        cout << "masukan panjang = ";
        cin >>pp;
        cout<< "masukan lebar = ";
        ...
        pb = pp*pl*pt;
        cout<<endl;
        cout << "hasil persegi panjang 3d (balok) = "<<pb<<endl;
        break;
        case 10:
        cout << "persegi 3d (kubus) "<<endl;
        int ss,hsl;
        cout << "masukan sisi = ";
        cin>>ss;
        hsl = ss*ss*ss;
        ...
        cout <<endl;
        cout << "hasil pesrsegi 3d (kubus) = "<<hsl<<endl;
        break;
